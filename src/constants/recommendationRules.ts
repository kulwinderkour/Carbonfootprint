...
const activeKm = (i: FootprintInput) =>
  (i.transport.bike ?? 0) + (i.transport.walk ?? 0);
...
export const RULES: Rule[] = [
  // ── TRANSPORT
  {
    ...
    estimatedBenefitKg: 35, estimatedBenefitText: "~35 kg CO₂e / month",
    difficulty: "easy", priority: 9, personas: ["student", "young_professional"],
  ...
  },
  {
    ...
    estimatedBenefitKg: 55, estimatedBenefitText: "~55 kg CO₂e / month",
    difficulty: "easy", priority: 10, personas: ["hosteller"],
  ...
  },
  {
    ...
    estimatedBenefitKg: 18, estimatedBenefitText: "~18 kg CO₂e / month",
    difficulty: "hard", priority: 5, personas: "all",
  ...
  },
  {
    ...
    estimatedBenefitKg: 380, estimatedBenefitText: "~380 kg CO₂e per flight skipped",
    difficulty: "medium", priority: 10, personas: "all",
  ...
  },
  {
    ...
    estimatedBenefitKg: 6, estimatedBenefitText: "~6 kg CO₂e / month",
    difficulty: "easy", priority: 4, personas: "all",
  ...
  // ── ENERGY
  {
    ...
    estimatedBenefitKg: 25, estimatedBenefitText: "~25 kg CO₂e / month",
    difficulty: "easy", priority: 8, personas: ["hosteller", "student"],
  ...
  },
  {
    ...
    estimatedBenefitKg: 180, estimatedBenefitText: "~180 kg CO₂e / month",
    difficulty: "hard", priority: 9, personas: ["homeowner"],
    condition: (i) => i.electricityUnitsKwh > 300,
  },
  {
    id: "E3", category: "energy",
    title: "Set AC to 24 °C + 1-hour timer",
    reason: "Every degree below 24 °C adds ~6% to AC load.",
    estimatedBenefitKg: 22, estimatedBenefitText: "~22 kg CO₂e / month",
    difficulty: "easy", priority: 7, personas: "all",
    condition: (i) => i.acHoursPerDay >= 4,
  },
  {
    id: "E4", category: "energy",
    title: "Swap to LED + power-strip switch-off",
    reason: "Standby and old bulbs are quiet drains, especially for students.",
    estimatedBenefitKg: 8, estimatedBenefitText: "~8 kg CO₂e / month",
    difficulty: "easy", priority: 5, personas: ["student", "young_professional"],
  ...
  // ── FOOD
  {
    ...
    estimatedBenefitKg: 70, estimatedBenefitText: "~70 kg CO₂e / month",
    difficulty: "medium", priority: 9, personas: "all",
  ...
  },
  {
    ...
    estimatedBenefitKg: 15, estimatedBenefitText: "~15 kg CO₂e / month",
    difficulty: "easy", priority: 6, personas: "all",
  ...
  },
  {
    ...
    estimatedBenefitKg: 5, estimatedBenefitText: "~5 kg CO₂e / month",
    difficulty: "easy", priority: 4, personas: "all",
  ...
  // ── WASTE
  {
    id: "W1", category: "waste",
    title: "Two-bin recycling at home",
    reason: "Less than 30% of your waste is recycled.",
    estimatedBenefitKg: 7, estimatedBenefitText: "~7 kg CO₂e / month",
    difficulty: "easy", priority: 5, personas: "all",
    condition: (i) => {
